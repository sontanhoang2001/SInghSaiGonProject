                    ...
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form class="row g-4" id="login-form" action="#" method="post" >
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating">
                                        <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Full Name">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-animation w-100" type="submit" onclick="user_register()" name="register-submit" id="register-submit">Sign Up</button>
                                </div>
                            </form>
                        </div>
