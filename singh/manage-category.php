        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="add-category.php">Add Categories</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
				 ...
				 ?>
                  <tr>
                    ...
                    <td>
						<?php
							echo "<button type='button' class='btn btn-block btn-info'><a href='add-category.php?id=".$row['id']."' style='color:#ececec;'>Edit</a></button>";
